...
internal fun SearchUiState.toSettingsScreenState(): SettingsScreenState {
    ...
    return SettingsScreenState(
        ...
        base64CodecEnabled = tools.base64CodecEnabled,
        hashGeneratorEnabled = tools.hashGeneratorEnabled,
        urlCodecEnabled = tools.urlCodecEnabled,
        timestampConverterEnabled = tools.timestampConverterEnabled,
...
private data class ToolsMapperState(
    ...
    val base64CodecEnabled: Boolean,
    val hashGeneratorEnabled: Boolean,
    val urlCodecEnabled: Boolean,
    val timestampConverterEnabled: Boolean,
...
private fun SearchUiState.toToolsSettingsState() =
    ToolsMapperState(
        ...
        base64CodecEnabled = base64CodecEnabled,
        hashGeneratorEnabled = hashGeneratorEnabled,
        urlCodecEnabled = urlCodecEnabled,
        timestampConverterEnabled = timestampConverterEnabled,
