...
data class SettingsScreenCallbacks(
    ...
    val onToggleBase64Codec: (Boolean) -> Unit,
    val onToggleHashGenerator: (Boolean) -> Unit,
    val onToggleUrlCodec: (Boolean) -> Unit,
    val onToggleTimestampConverter: (Boolean) -> Unit,
