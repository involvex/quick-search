...
internal fun buildSettingsScreenCallbacks(
    ...
    SettingsScreenCallbacks(
        ...
        onAddTermuxSavedCommand = viewModel::addTermuxSavedCommand,
        onDeleteTermuxSavedCommand = viewModel::deleteTermuxSavedCommand,
        onSetTermuxEnabled = viewModel::setTermuxIntegrationEnabled,
        onSetTermuxPrefix = viewModel::setTermuxPrefix,
        onSetTermuxExecutionMode = viewModel::setTermuxExecutionMode,
        onSetTermuxVariantPackage = viewModel::setTermuxVariantPackage,
