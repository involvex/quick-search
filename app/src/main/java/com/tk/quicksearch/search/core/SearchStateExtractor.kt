...
internal object SearchStateExtractor {
    ...
    fun extractFeatureState(s: SearchUiState) =
        SearchFeatureState(
            ...
            base64CodecEnabled = s.base64CodecEnabled,
            hashGeneratorEnabled = s.hashGeneratorEnabled,
            urlCodecEnabled = s.urlCodecEnabled,
            timestampConverterEnabled = s.timestampConverterEnabled,
            ...
            termuxSavedCommands = s.termuxSavedCommands,
