        ...
        scope.launch(startupDispatcher) {
            ...
            updateFeatureState { state ->
                state.copy(
                    ...
                    base64CodecEnabled = userPreferences.isBase64CodecEnabled(),
                    hashGeneratorEnabled = userPreferences.isHashGeneratorEnabled(),
                    urlCodecEnabled = userPreferences.isUrlCodecEnabled(),
                    timestampConverterEnabled = userPreferences.isTimestampConverterEnabled(),
                    ...
                    termuxSavedCommands = userPreferences.getTermuxSavedCommands(),
                    termuxIntegrationEnabled = userPreferences.isTermuxIntegrationEnabled(),
                    termuxDefaultExecutionMode = userPreferences.getTermuxDefaultExecutionMode(),
                    termuxPrefix = userPreferences.getTermuxPrefix(),
                    termuxVariantPackage = userPreferences.getTermuxVariantPackage(),
                    hasApiKey = hasApiKey,
